...
namespace novelaweb2.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(WebNovelasDbContext context)
        {
            _context = context;
        }
        ...
        {
            var webNovelasDbContext = _context.Usuarios.Include(u => u.Rol);
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreUsuario,Correo,Contrasena,FechaRegistro,RolId,Bio,AvatarUrl")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreUsuario,Correo,Contrasena,FechaRegistro,RolId,Bio,AvatarUrl")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
